import { FETCH_WALL_POSTS, LESS_WALL_POSTS, FETCH_WALL_POSTS_SUCCESS, FETCH_WALL_POSTS_FAILURE,
  FETCH_MORE_WALL_POSTS_SUCCESS, FETCH_MORE_WALL_POSTS_FAILURE, SUBMIT_USER_WALL_POST_SUCCESS,
  SUBMIT_USER_WALL_POST_FAILURE, SHOW_WALL_POST_INPUT, HIDE_WALL_POST_INPUT
...
export default function wallPosts(state = INITIAL_STATE, action) {
  switch (action.type) {
    case SUBMIT_USER_WALL_POST_SUCCESS:
      return {
        ...state,
        wallPostSuccessfull: true
      };
    case SUBMIT_USER_WALL_POST_FAILURE:
      return {
        wallPostSuccessfull: false
      };
